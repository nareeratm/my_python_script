...
# Import the datetime module to work with date and times
import datetime
...
def get_time_of_day():
    ...
    # Determine the day time of the day based on the hour
    if current_hour <12:
        return "Morning"
...
def main():
    ...
    # Farewell message
    print(f"Farewell, {name}! Have a wonderful {time_of_day}")
